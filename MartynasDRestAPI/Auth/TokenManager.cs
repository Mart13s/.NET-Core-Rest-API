...
namespace MartynasDRestAPI.Auth
{
    ...
    public class TokenManager : ITokenManager
    {
        ...
        private readonly SymmetricSecurityKey _autoSigningKey;
        ...
        {
            _autoSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(configuration["JWT:Secret"]));
        ...
        public async Task<string> CreateAccessTokenAsync(RestUser user)
        {
            ...
            var accessSecurityToken = new JwtSecurityToken(
                ...
                audience: _audience,
                claims: authClaims,
                signingCredentials: new SigningCredentials(_autoSigningKey, SecurityAlgorithms.HmacSha256)
                );
